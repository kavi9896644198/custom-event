...
$inum=1;
foreach ($save_ticket as $key => $value) {
						$keys= substr($key, 0, -1);
						$keynum = $key[strlen($key)-1];
						if($keys == 'text_block'){
							?>
							<div class="page-content-repeater-col classticketremove<?php echo $inum; ?>" data-lastdivid="<?php echo $keynum; ?>">
									...
									<div class="page-content-repeater-col-box">
										<div class="text-block">
											<textarea name="ticket[<?php echo $key; ?>]"><?php echo esc_attr($value);?></textarea>
										</div>
									</div>
									<div class="page-content-repeater-col-box">
										<div class="add-remove-btn">

											<a $save_program class="remove-text-block remove-block" data-id="classticketremove<?php echo $inum; ?>"><img src="/wp-content/uploads/2023/05/minus.png"></a>
										</div>
									</div>
								</div>
							<?php 
								...
								<div class="page-content-repeater-col-box">
									<div class="upload-image-block">
										<div class="upload-image-btn">
											<a $save_program id="img-upload" class="img-upload-class">
												...
												<input type="hidden" name="ticket[<?php echo $key; ?>]" id="block_photo" value="<?php echo $value;?>">
											</div>
									...
									<div class="page-content-repeater-col-box">
										<div class="add-remove-btn">
											...
											<a $save_program class="remove-photo-block remove-block" data-id="classticketremove<?php echo $inum; ?>"><img src="/wp-content/uploads/2023/05/minus.png"></a>
										</div>
									</div>
								</div>
							<?php
						...
						if($keys == 'tickettitle'){
							...
							?>
							<div class="page-content-repeater-col classticketremove<?php echo $i; ?>" data-lastdivid="<?php echo $keynum; ?>">
						<div class="page-content-repeater-col-box">
								...
								<div class="ticket-block remove_<?php echo $ticket_num;?>">
									...
									<div class="ticket-block-right">
										<div class="ticket-block-content">
											...
											<input type="text" name="ticket[tickettitle<?php echo $keynum; ?>]" value="<?php echo $save_ticket->$tickettitle;?>">
											</div>
											<div class="ticket-block-content-col">
												<label>Ticket Date and time</label>
												<div class="date-col event-date" id="ticket-event-choose">
													<select id="ticketmonth" name="ticket[ticketmonth<?php echo $keynum; ?>]">
													...
													$selected = $save_ticket->$selected_year == $i_year ? ' selected' : '';
													echo '<option value="'.$i_year.'"'.$selected.'>'.$i_year.'</option>'."\n";
													}
													?>
													</select>
													<select id="tickethours" name="ticket[tickethours<?php echo $keynum; ?>]">
													<?php 
													$selected_d = 'tickethours'.$keynum;
													for ($i_day = 1; $i_day <= 24; $i_day++) { 
													$selected = $save_ticket->$selected_d == $i_day ? ' selected' : '';
													if($i_day <= 9 ){
													...
													<select id="ticketminutes" name="ticket[ticketminutes<?php echo $keynum; ?>]">
													<?php 
													$selected_t = 'ticketminutes'.$keynum;
													for ($i_day = 0; $i_day <= 60; $i_day++) { 
													$selected = $save_ticket->$selected_t == $i_day ? ' selected' : '';
													if($i_day <= 9 ){
													echo '<option value="'.$i_day.'" '.$selected.'>0'.$i_day.'</option>'."\n";
													}else{
													echo '<option value="'.$i_day.'" '.$selected.'>'.$i_day.'</option>'."\n";
													...
													$checked = ($save_ticket->$checkdata == 1) ? 'checked' : '';
													?>
													<div class="event-date-col">
														<input type="checkbox" id="ticketnodate" name="ticket[ticketnodatenodate<?php echo $keynum; ?>]" value="1" <?php echo $checked;?>>
											...
											<input type="text" name="ticket[ticketlink<?php echo $keynum; ?>]" value="<?php echo $save_ticket->$ticketlink;?>">
											</div>
										</div>
						...
						<a $save_program class="remove-block remove-ticket-block" data-id="classticketremove<?php echo $i; ?>"><img src="/wp-content/uploads/2023/05/minus.png"></a>
						</div>
						</div>
					</div>
							<?php 
				...
				<div class="page-content-repeater-col classticketremove<?php echo $i; ?>" data-lastdivid="<?php echo $keynum; ?>">
					...
					//echo "<pre>";print_r($blocks_days);die;	
							if(count($blocks_days) <= 1){ 
								...
								$selectdays = $save_ticket->$selectedblock_day;
								?>
									...
									<div class="ticket-block-right">
										<div class="ticket-block-content">
											<div class="ticket-block-content-col">
												...
												<select class="choose-day" name="ticket[block_day<?php echo $keynum; ?>]">
											...
											<div class="ticket-block-content-col">
												<div class="time-frame" id="ticket_<?php echo $keynum;?>">
													<?php $programs_block = json_decode(get_post_meta( $post->ID, 'programs_block', true ));
				//echo "<pre>";print_r($blocks_days);
													$program_num = 1;
													$prog_num = 1;
													//echo "<pre>";print_r($save_ticket->$timehours);die;
													foreach ($save_ticket->$timehours as $keyprogram => $valueprogram) {
														
														?>
														<div class="time-frame-repeater time_remove_t_<?php echo $keynum;?>_<?php echo $keyprogram;?>">
															...
															//echo "<pre>";print_r($save_ticket);die;
																...
																//echo "<pre>";print_r($valuedesc);
															?>
																	<select id="timehours" name="ticket[timehours<?php echo $keynum; ?>][<?php echo $keyprogram;?>]">
																		<?php 
																	...
																	<select id="timeminutes" name="ticket[timeminutes<?php echo $keynum; ?>][<?php echo $keyprogram;?>]">
																		<?php 
$times_minutes = 'timeminutes'.$keynum;
																		for ($i_day = 0; $i_day <= 60; $i_day++) { 
																			$selectedday = $save_ticket->$timeminutes->$keyprogram  == $i_day ? ' selected' : '';
																			if($i_day <= 9 ){
															...
															<div class="time-frame-col-right">
																...
																<input type="text" name="ticket[ticket_description<?php echo $keynum; ?>][<?php echo $keyprogram;?>]" value="<?php echo $save_ticket->$ticket_description->$keyprogram;?>">
															</div>
															<div class="delete-time-frame">
																<a class="time_frame_remove" data-id="time_remove_t_<?php echo $keynum;?>_<?php echo $keyprogram;?>"><img src="/wp-content/uploads/2023/05/delete12_1.png"></a>
															</div>
										...
										<div class="add-time">
											<a class="add-times" data-num="<?php echo $keynum;?>" data-block="ticket" data-id="ticket_<?php echo $keynum;?>" datanum="1">Add Time</a>
										</div>
									</div>
								</div>
							<?php } ?>
					...
					<div class="page-content-repeater-col-box">
						<div class="add-remove-btn">
							<a $save_program class="remove-block add_remove_program" data-id="classticketremove<?php echo $i; ?>"><img src="/wp-content/uploads/2023/05/minus.png"></a>
						</div>
					</div>
				</div>
			<?php 
