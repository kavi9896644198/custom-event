<?php 
//die('dfgd');
//echo "<pre>";print_r($save_photo);die;
$i = 1;
foreach ($save_photo as $key => $value) {
						$keys= substr($key, 0, -1);
						$keynum = $key[strlen($key)-1];
						if($keys == 'text_block'){
							?>
							<div class="page-content-repeater-col classphotoremove<?php echo $i; ?>" data-lastdivid="<?php echo $keynum; ?>">
									...
									<div class="page-content-repeater-col-box">
										<div class="text-block">
											<textarea name="photo[<?php echo $key; ?>]"><?php echo esc_attr($value);?></textarea>
										</div>
									</div>
									<div class="page-content-repeater-col-box">
										<div class="add-remove-btn">

											<a $save_program class="remove-text-block remove-block" data-id="classphotoremove<?php echo $i; ?>"><img src="/wp-content/uploads/2023/05/minus.png"></a>
										</div>
									</div>
								</div>
							<?php 
								...
								<div class="page-content-repeater-col-box">
									<div class="upload-image-block">
										<div class="upload-image-btn">
											<a $save_program id="img-upload" class="img-upload-class">
												...
												<input type="hidden" name="photo[<?php echo $key; ?>]" id="block_photo" value="<?php echo $value;?>">
											</div>
									...
									<div class="page-content-repeater-col-box">
										<div class="add-remove-btn">
											...
											<a $save_program class="remove-photo-block remove-block" data-id="classphotoremove<?php echo $i; ?>"><img src="/wp-content/uploads/2023/05/minus.png"></a>
										</div>
									</div>
								</div>
							<?php
								...
								<div class="ticket-block remove_<?php echo $ticket_num;?>">
									...
									<div class="ticket-block-right">
										<div class="ticket-block-content">
											...
											<input type="text" name="photo[tickettitle<?php echo $keynum; ?>]" value="<?php echo $save_photo->$tickettitle;?>">
											</div>
											<div class="ticket-block-content-col">
												<label>Ticket Date and time</label>
												<div class="date-col event-date" id="ticket-event-choose">
													<select id="ticketmonth" name="photo[ticketmonth<?php echo $keynum; ?>]">
													...
													$selected = $save_photo->$selected_year == $i_year ? ' selected' : '';
													echo '<option value="'.$i_year.'"'.$selected.'>'.$i_year.'</option>'."\n";
													}
													?>
													</select>
													<select id="tickethours" name="photo[tickethours<?php echo $keynum; ?>]">
													<?php 
													$selected_d = 'tickethours'.$keynum;
													for ($i_day = 1; $i_day <= 24; $i_day++) { 
													$selected = $save_photo->$selected_d == $i_day ? ' selected' : '';
													if($i_day <= 9 ){
													...
													<select id="ticketminutes" name="photo[ticketminutes<?php echo $keynum; ?>]">
													<?php 
													$selected_t = 'ticketminutes'.$keynum;
													for ($i_day = 0; $i_day <= 60; $i_day++) { 
													$selected = $save_photo->$selected_t == $i_day ? ' selected' : '';
													if($i_day <= 9 ){
													echo '<option value="'.$i_day.'" '.$selected.'>0'.$i_day.'</option>'."\n";
													}else{
													echo '<option value="'.$i_day.'" '.$selected.'>'.$i_day.'</option>'."\n";
													...
													$checked = ($save_photo->$checkdata == 1) ? 'checked' : '';
													?>
													<div class="event-date-col">
														<input type="checkbox" id="ticketnodate" name="photo[ticketnodatenodate<?php echo $keynum; ?>]" value="1" <?php echo $checked;?>>
											...
											<input type="text" name="photo[ticketlink<?php echo $keynum; ?>]" value="<?php echo $save_photo->$ticketlink;?>">
											</div>
										</div>
						...
						<a $save_program class="remove-block remove-ticket-block" data-id="classphotoremove<?php echo $i; ?>"><img src="/wp-content/uploads/2023/05/minus.png"></a>
						</div>
						</div>
					</div>
							<?php 
			...
			if($keys == 'block_day'){
				...
				<div class="page-content-repeater-col classphotoremove<?php echo $i; ?>" data-lastdivid="<?php echo $keynum; ?>">
					...
					//echo "<pre>";print_r($blocks_days);die;	
							if(count($blocks_days) <= 1){ 
								...
								$selectdays = $save_photo->$selectedblock_day;
								?>
									...
									<div class="ticket-block-right">
										<div class="ticket-block-content">
											<div class="ticket-block-content-col">
												...
												<select class="choose-day" name="photo[block_day<?php echo $keynum; ?>]">
											...
											<div class="ticket-block-content-col">
												<div class="time-frame" id="photo_<?php echo $keynum;?>">
				...
				//echo "<pre>";print_r($blocks_days);
													...
													foreach ($save_photo->$timehours as $keyprogram => $valueprogram) {
														?>
														<div class="time-frame-repeater time_remove_b_<?php echo $keynum;?>_<?php echo $keyprogram;?>">
															<div class="time-frame-col-left">
																<label>Time Frames</label>
																<div class="event-date" id="ticket-time">
																	<select id="timehours" name="photo[timehours<?php echo $keynum; ?>][<?php echo $keyprogram;?>]">
																		<?php 
																	...
																	<select id="timeminutes" name="photo[timeminutes<?php echo $keynum; ?>][<?php echo $keyprogram;?>]">
																		<?php 
$times_minutes = 'timeminutes'.$keynum;
																		for ($i_day = 0; $i_day <= 60; $i_day++) { 
																			$selectedday = $save_photo->$timeminutes->$keyprogram == $i_day ? ' selected' : '';
																			if($i_day <= 9 ){
															...
															<div class="time-frame-col-right">
																...
																<input type="text" name="photo[ticket_description<?php echo $keynum; ?>][<?php echo $keyprogram;?>]" value="<?php echo $save_photo->$ticket_description->$keyprogram;?>">
															</div>
															
															<div class="delete-time-frame">
																<a class="time_frame_remove" data-id="time_remove_b_<?php echo $keynum;?>_<?php echo $keyprogram;?>"><img src="/wp-content/uploads/2023/05/delete12_1.png"></a>
															</div>
														</div>
													<?php } ?>
												</div>
										...
										<div class="add-time">
											<a class="add-times" data-num="<?php echo $keynum;?>" data-block="photo" data-id="photo_<?php echo $keynum;?>" datanum="1">Add Time</a>
										</div>
									</div>
								</div>
							<?php } ?>
					...
					<div class="page-content-repeater-col-box">
						<div class="add-remove-btn">
							<a $save_program class="remove-block add_remove_program" data-id="classphotoremove<?php echo $i; ?>"><img src="/wp-content/uploads/2023/05/minus.png"></a>
						</div>
					</div>
				</div>
			<?php 
